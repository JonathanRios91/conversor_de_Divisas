...
public class Menu {
    ...
    public int leerOpcionPrincipal(){
        ...
        System.out.println("Digite el numero de la opcion que de sea realizar.");
        System.out.println("------------------------------------------------------");
    ...
    public void mostrarMenuMonedas(String denominacion){
        System.out.println("------------------------------------------------------");
        System.out.println("Seleccione divisa que desea convertir" + denominacion + ": \n");
    ...
    public String leerOpcionMoneda(){
        ...
        while (!monedasDisponibles.toLowerCase().contains(opcion)) {
            System.out.println("La opción escogida no se puede consultar");
            System.out.println("Digita una de las opciones disponibles que te aparece en la pantalla");
            System.out.println("------------------------------------------------------");
    ...
    public void imprimirConversiones(ArrayList<Conversion> listaDeConversiones) {
        if (listaDeConversiones.isEmpty()) {
            ...
            for (int i = 0; i < listaDeConversiones.size(); i++) {
                ...
                System.out.println("Moneda origen: " + conversion.getMonedaParaCambio());
                System.out.println("Moneda objetivo: " + conversion.getMonedaDeConversion());
                System.out.println("Cantidad a cambiar: " + conversion.getValorDeCambio());
                System.out.println("Cantidad obtenida: " + conversion.getValorConversion());
                System.out.println("Fecha y hora: " + formatDateTime(conversion.getHoraDeLaTransaccion()));
                System.out.println("------------------------------------------------------");
            }
        }
    }
